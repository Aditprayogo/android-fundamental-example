package com.aditprayogo.myalarmmanager
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun showAlarmNotification(context: Context, title: String, message: String, notifId: Int){
        ...
        val builder = NotificationCompat.Builder(context,CHANNEL_ID)
            .setSmallIcon(R.drawable.ic_access_time_24px)
    ...
    fun setOneTimeAlarm(context: Context, type: String, date: String, time: String, message: String) {
        ...
        //akan dieksekusi ketika waktu sama
        //dengan waktu yang ada di android
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        val pendintIntent = PendingIntent.getBroadcast(context, ID_REPEATING,intent, 0)

        alarmManager.setInexactRepeating(
            AlarmManager.RTC_WAKEUP,calendar.timeInMillis, AlarmManager.INTERVAL_DAY, pendintIntent
        )
