package com.aditprayogo.mydeepnavigation
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        notifDetailIntent.putExtra(DetailActivity.EXTRA_TITLE, getString(R.string.detail_title))
        notifDetailIntent.putExtra(DetailActivity.EXTRA_MESSAGE, getString(R.string.detail_message))
