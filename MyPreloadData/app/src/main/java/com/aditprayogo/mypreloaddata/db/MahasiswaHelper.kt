    ...
    fun getAllData(): ArrayList<MahasiswaModel> {
        ...
        if (cursor.count > 0) {
            do {
                ...
                cursor?.apply {
                    mahasiswaModel.id = getInt(cursor.getColumnIndexOrThrow(_ID))
                    mahasiswaModel.name = getString(cursor.getColumnIndexOrThrow(NAMA))
                    mahasiswaModel.nim = getString(cursor.getColumnIndexOrThrow(NIM))
                }
